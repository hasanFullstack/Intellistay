      ...
      <div className="container-fluid py-4">
        ...
        <div className="row mb-4">
          <div className="col-md-8">
            ...
            <p className="text-muted">Manage your hostels and rooms</p>
          </div>
          ...
          <div className="col-md-3">
            <div className="stat-card card border-0 shadow-sm">
              <div className="card-body">
                ...
                <h6 className="card-title text-muted mt-3">Available Beds</h6>
                <h3 className="fw-bold text-dark">
                  {getTotalAvailableBedsCount()}
                </h3>
              </div>
            </div>
          </div>
                  ...
                  return (
                    <div className="accordion-item" key={hostel._id}>
                      ...
                      <div
                        ...
                        style={{
                          display:
                            expandedHostelId === hostel._id ? "block" : "none",
                        }}
                      >
